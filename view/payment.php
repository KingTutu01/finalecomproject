        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              ...
              <input type="hidden" name="" id="amount" value="<?php echo $checkOutAmt['Result']; ?>">
            </tr>
...
<form id="paymentForm" >
    ...
    <div class="form-group">
        ...
        <input type="tel" id="amount" value="<?= $checkOutAmt['Result'] ?>" required />

    </div>

    <div class="container btn">

    <button id="paymentForm" type ="button " onclick="payWithPaystack()">
              Pay now
            </button>
    </div>
